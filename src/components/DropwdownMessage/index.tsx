...
import UserTwo from "../../../public/user-02.png";
import UserThree from "../../../public/user-03.png";
import UserFour from "../../../public/user-04.png";
    ...
    <li className="relative">
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            <Link
              className="flex gap-4.5 border-t border-stroke px-4.5 py-3 "
              href="/messages"
            >
              <div className="h-12.5 w-12.5 rounded-full">
                <img src={UserTwo.src} alt="User" />
              </div>

              <div>
                <h6 className="text-sm font-medium text-black e">
                  Mariya Desoja
                </h6>
          ...
          <li>
            ...
            >
              <div className="h-12.5 w-12.5 rounded-full">
                <img src={UserThree.src} alt="User" />
              </div>
