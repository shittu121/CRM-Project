...
const LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg 
        ...
        viewBox="0 0 24 24" style={{marginLeft: "-4px"}}>
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
        viewBox="0 0 36 36" style={{marginLeft: "-4px"}}>
        <path fill="currentColor" 
...

  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
        viewBox="0 0 32 32" style={{marginLeft: "-4px"}}>
        <path fill="currentColor" 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
       viewBox="0 0 24 24" style={{marginLeft: "-4px"}}>
        ...
        stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 0 
...

  {
    ...
    url: "/bill",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 576 512" style={{marginLeft: "-4px"}}>
        <path fill="currentColor" d="M64 64C28.7 64 0 92.7 
...
export default function SideBar() {
  ...
  return (
    <div>
      <aside
        className={`absolute font-roboto  bg-primary left-0 top-0 z-50 flex h-screen w-72 flex-col  overflow-y-hidden  duration-300 ease-linear  lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6  flex flex-col gap-1.5">
              {LINKS.map((item, index) => (
                <li key={index}>
                  ...
                  <Link
                    href={item.url}
                    className={`group !text-[16px] text-black   relative flex items-center gap-2.5 rounded-[4px] py-2 px-4   duration-300 ease-in-out hover:bg-emerald-deep ${
                      pathname === item.url && "bg-emerald-deep text-white"
                    } `}
                  >
                    <span>{item.icon}</span>
                    {item.name}
