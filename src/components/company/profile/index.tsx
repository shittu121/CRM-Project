        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex items-start mb-8">
              ...
              <div>
                <p className="text-lg"><strong>Partner Code:</strong> {user.partnerCode}</p>
                <p className="text-lg"><strong>Partner Name:</strong> {user.name}</p>
                <p className="text-lg"><strong>Channel Name:</strong> {user.channelName}</p>
                <p className="text-lg"><strong>Appointment Date:</strong> {user.appointmentDate}</p>
                <p className="text-lg"><strong>Assigned Apollo Branch:</strong> {user.assignedBranch}</p>
                <p className="text-lg"><strong>Mobile Number:</strong> {user.primaryPhone} <span className="text-gray-500">PRIMARY</span></p>
                <p className="text-lg"><strong></strong> {user.secondaryPhone} <span className="text-gray-500">SECONDARY</span></p>
                <p className="text-lg"><strong>Email Id:</strong> {user.email}</p>
                <p className="text-lg"><strong>Communication Address:</strong> {user.address}</p>
              </div>
            </div>
          ...
          <div className="border-l pl-8">
            ...
            <div className="flex items-start mb-8">
              ...
              <div>
                <p className="text-lg"><strong>{user.reportingTo.name}</strong></p>
